...
void cargarLibros() {
	...
	libros[0][0] = "Aventuras"; libros[0][1] = "Luigi vs Bowser"; libros[0][2] = "Carlos Centeno";
	libros[1][0] = "Aventuras"; libros[1][1] = "Mario y el fin del universo"; libros[1][2] = "Arnold Toro";
	libros[2][0] = "Aventuras"; libros[2][1] = "Mario y sus amigos"; libros[2][2] = "Agustin Lara";
	libros[3][0] = "Deportes"; libros[3][1] = "Los 10 mandamientos del futbol"; libros[3][2] = "Luis Rapalo";
	libros[4][0] = "Deportes"; libros[4][1] = "El origen de los deportes"; libros[4][2] = "Marlon Ramirez";
	libros[5][0] = "Deportes"; libros[5][1] = "Deportes extremos: ventajas y desventajas"; libros[5][2] = "Marcos Ramirez";
	libros[6][0] = "Deportes"; libros[6][1] = "Los juegos olimpicos a traves del tiempo"; libros[6][2] = "Alicia rodas";
	...
	libros[9][0] = "Juegos"; libros[9][1] = "Los 50 mejores videojuegos de todos los tiempos"; libros[9][2] = "Luis Rapalo";
	libros[10][0] = "Juegos"; libros[10][1] = "Ser Gamer; ¿La profesion del futuro?"; libros[10][2] = "Arnold Toro";
	libros[11][0] = "Juegos"; libros[11][1] = "Los videojuegos y la vida social"; libros[11][2] = "Karen Fernandez";
	libros[12][0] = "Musica"; libros[12][1] = "Como empezar a escribir una cancion desde cero"; libros[12][2] = "Carlos Ortiz";
	libros[13][0] = "Musica"; libros[13][1] = "Como leer una partitura"; libros[13][2] = "Sebastian Obando";
	libros[14][0] = "Musica"; libros[14][1] = "Como influye la musica en las personas"; libros[14][2] = "Sofia Ponce";
}
